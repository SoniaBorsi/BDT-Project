...
app.title = "Australian Healthcare Resource Allocation"
server = app.server


mdf = pd.read_csv('dataset/malaysia_life_expectancy.csv')  
wdf = pd.read_csv('dataset/who_life_expectancy.csv')  
